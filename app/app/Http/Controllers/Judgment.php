...
class Judgment extends Controller
{
    ...
    public function create()
    {
        ...
        return view('judgment.create', compact( 'correspondents', 'judgment_types', 'judgment_subtypes'));
    }
    ...
    public function edit($id)
    {
        ...
        $judgment_types = JudgmentTypeModel::all();
        $judgment_subtypes = JudgmentSubTypeModel::all();
        return view('judgment.edit', compact('item', 'correspondents', 'judgment_types', 'judgment_subtypes'));
    }
